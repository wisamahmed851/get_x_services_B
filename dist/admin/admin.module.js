...
exports.AdminsModule = AdminsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([admin_entity_1.Admin, roles_entity_1.Role])],
        providers: [admin_service_1.AdminsService],
        controllers: [admin_controller_1.AdminsController],
    })
], AdminsModule);
